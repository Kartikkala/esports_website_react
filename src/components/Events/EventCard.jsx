...
const EventCard = ({game, imageBanner, prizepool, fee, date, totalPlayersRegistered, totalSlots, joinId, registerButtonTxt, registerButtonFn, deleteEventButtonFn, admin}) => {
    return (
