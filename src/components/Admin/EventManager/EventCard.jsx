import { GameStatusBar } from '../GameManager/GameStatusBar';
import RegularInfoTyping from '../../Events/RegularInfoTyping';

// eslint-disable-next-line react/prop-types
const EventCard = ({gameName, cameraAngle , maxTeams, maxTeamMembers, modeName, imageBanner, buttonText, buttonFunction}) => {
    return (
