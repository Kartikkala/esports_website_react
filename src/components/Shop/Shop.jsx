...
export function PricingSection11() {
  ...
  return (
    <section className="overflow-hidden p-4 h-full items-center flex">
      <div className="container mx-auto flex flex-col items-center p-8 bg-gray-900/60 backdrop-blur-xl rounded-xl">
        <Typography variant="h1" color="white" className="text-xl mb-4">
          Recharge your wallet with one of our affordable plans
        </Typography>
        <Typography
          variant="lead"
          className="hidden md:block mb-10 font-normal !text-gray-500 max-w-xl"
        >
